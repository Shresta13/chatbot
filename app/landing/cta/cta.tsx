  ...
  return (
    <section ref={sectionRef} className="container mx-auto max-w-4xl px-6 py-20 bg-linear-to-b from-white to-gray-50">
      <div className={`mx-auto max-w-4xl transition-all duration-1000 ${
        ...
        <div className="relative overflow-hidden bg-linear-to-br from-green-600 via-emerald-600 to-teal-600 rounded-3xl p-12 md:p-16 text-center text-white shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg sm:text-xl mb-10 text-green-50 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-green-700 rounded-xl font-bold hover:bg-gray-50 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Start for Free
